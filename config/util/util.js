const weapon = require('../data/weaponGuide.js')
const ninja = require('../data/ninjaGuide.js')
const relics = require('../data/relicsGuide.js')
const pvp = require('../data/3v3Guide.js')
const bounties = require('../data/bountiesGuide.js')
const clans = require('../data/clanGuide.js')
      ...
      case 'English':
        switch (guide) {
          case 'weaponRarity':
            ...
            weapon.EnglishWeaponGuide[1][page - 1].components[0].components[2].data.label = `${page}/5`
          ...
          case 'ninja':
            ninja.EnglishNinjaGuide[page].components[0].components[2].data.label = `${page}/5`
